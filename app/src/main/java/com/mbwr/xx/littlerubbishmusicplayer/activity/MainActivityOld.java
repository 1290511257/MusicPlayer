...
public class MainActivityOld extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAlbumExpandableListAdapter = new AlbumExpandableListAdapter(gData, iData, MainActivityOld.this) {
            @Override
            public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
                ViewHolderGroup groupHolder;
                if (convertView == null) {
                    convertView = LayoutInflater.from(MainActivityOld.this).inflate(
...
//                mSongsLayout.setVisibility(View.VISIBLE);
                Intent intent1 = new Intent(MainActivityOld.this, AlbumSongListActivity.class);
...
//        popupWindow.showAsDropDown(getWindow().getDecorView());
        ...
        if (manager.showSoftInput(view, InputMethodManager.SHOW_FORCED))
            Log.e("------->", "弹出软键盘失败!!");
//        showSoftInputFromWindow(MainActivityOld.this, mAlbumEditText);
    }
